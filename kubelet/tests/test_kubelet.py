...
def test_system_container_metrics(monkeypatch, aggregator, tagger):
    ...
    calls = [
        mock.call('kubernetes.kubelet.cpu.usage', 36755862.0, tags),
        mock.call('kubernetes.runtime.cpu.usage', 19442853.0, tags),
        mock.call('kubernetes.runtime.memory.rss', 101273600.0, tags),
        mock.call('kubernetes.kubelet.memory.rss', 88477696.0, tags),
    ]
    check.gauge.assert_has_calls(calls, any_order=True)
